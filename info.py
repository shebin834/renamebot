...
API_ID = int(environ['32557254'])
API_HASH = environ['448bb61d4711ef33afff691ac1bb0931']
BOT_TOKEN = environ['8728203307:AAGIgqWDXACPSbz3P_XswV8TwepAzPX15nA']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5079722109').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003952532442').split()]
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Shebin_Kallankunnan:Gid74LZ3K8nvmXdP@renamebot.xplacyv.mongodb.net/?appName=RenameBot")
DATABASE_NAME = environ.get('DATABASE_NAME', "LazyDeveloper")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1003803713967))
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Movies Adda™]()</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Shebin_kallankunnan_zero') # WITHOUT @
